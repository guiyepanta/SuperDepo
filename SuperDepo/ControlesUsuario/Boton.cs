...
namespace SuperDepo.ControlesUsuario
{
	...
	{		
		...
		private bool                 _FocusRectangleEnabled      = false;
        ...
        [Browsable(true),
        CategoryAttribute("Appearance"),
        Description("Ruta y nombre de la imagen dentro del assembly"),
        System.ComponentModel.RefreshProperties(RefreshProperties.Repaint)
        ]
        public string RutaImagen
        {
            ...
            {
                _rutaImagen = value;
                this.ImageNormal = SuperDepo.ControlesUsuario.ImageManager.ObtenerImagen(this.GetType().Assembly, value);
            }
        }
